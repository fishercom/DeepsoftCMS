...
using DeepsoftCMS.Service.Util;
using AutoMapper;
...
namespace DeepsoftCMS.Web.Areas.Admin.Controllers
{
    ...
    public class SchemaController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.TemplateList = serviceSchema.GetList(SchemaParentId);
            //ViewBag.SchemaParentId = SchemaParentId;
        ...
        public ActionResult Create(SchemaFormViewModel model)
        {
            ...
            ViewBag.TemplateList = serviceSchema.GetList(model.SchemaParentId);
        ...
        public ActionResult Edit(int Id)
        {
            ...
            ViewBag.TemplateList = serviceSchema.GetList(schema.SchemaParentId);
